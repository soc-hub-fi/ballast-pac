...
pub struct LINE_STRIDE_R(crate::FieldReader<u32, u32>);
impl LINE_STRIDE_R {
    #[inline(always)]
...
pub struct LINE_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> LINE_STRIDE_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn line_stride(&mut self) -> LINE_STRIDE_W {
        LINE_STRIDE_W { w: self }
    }
