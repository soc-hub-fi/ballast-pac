...
pub struct DATAIN_ADDR_HIGH_0_R(crate::FieldReader<u32>);
...
pub struct DATAIN_ADDR_HIGH_0_W<'a> {
    w: &'a mut W,
}
impl<'a> DATAIN_ADDR_HIGH_0_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn datain_addr_high_0(&mut self) -> DATAIN_ADDR_HIGH_0_W {
        DATAIN_ADDR_HIGH_0_W { w: self }
    }
