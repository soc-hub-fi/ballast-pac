...
impl WGS_ADDR_LOW_R {
    ...
    pub(crate) fn new(bits: u32) -> Self {
        WGS_ADDR_LOW_R(crate::FieldReader::new(bits))
    }
}
...
pub struct WGS_ADDR_LOW_W<'a> {
    w: &'a mut W,
}
impl<'a> WGS_ADDR_LOW_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn wgs_addr_low(&mut self) -> WGS_ADDR_LOW_W {
        WGS_ADDR_LOW_W { w: self }
    }
