...
pub struct DATAIN_ADDR_LOW_1_R(crate::FieldReader<u32, u32>);
impl DATAIN_ADDR_LOW_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        DATAIN_ADDR_LOW_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DATAIN_ADDR_LOW_1_R {
...
pub struct DATAIN_ADDR_LOW_1_W<'a> {
    w: &'a mut W,
}
impl<'a> DATAIN_ADDR_LOW_1_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn datain_addr_low_1(&mut self) -> DATAIN_ADDR_LOW_1_W {
        DATAIN_ADDR_LOW_1_W { w: self }
    }
