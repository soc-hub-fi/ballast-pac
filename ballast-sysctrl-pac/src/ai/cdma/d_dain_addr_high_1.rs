...
pub type DATAIN_ADDR_HIGH_1_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATAIN_ADDR_HIGH_1` writer - "]
pub type DATAIN_ADDR_HIGH_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DAIN_ADDR_HIGH_1_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datain_addr_high_1(&mut self) -> DATAIN_ADDR_HIGH_1_W<0> {
        DATAIN_ADDR_HIGH_1_W::new(self)
    }
