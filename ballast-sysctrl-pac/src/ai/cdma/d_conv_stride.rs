...
pub struct CONV_X_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> CONV_X_STRIDE_W<'a> {
...
pub struct CONV_Y_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> CONV_Y_STRIDE_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
...
impl W {
    #[doc = "Bits 0:2"]
    #[inline(always)]
    pub fn conv_x_stride(&mut self) -> CONV_X_STRIDE_W {
        CONV_X_STRIDE_W { w: self }
    }
    #[doc = "Bits 16:18"]
    #[inline(always)]
    pub fn conv_y_stride(&mut self) -> CONV_Y_STRIDE_W {
        CONV_Y_STRIDE_W { w: self }
    }
