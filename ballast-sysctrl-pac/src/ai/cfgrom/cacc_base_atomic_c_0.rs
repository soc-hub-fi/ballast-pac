...
pub struct CACC_BASE_ATOMIC_C_R(crate::FieldReader<u32, u32>);
impl CACC_BASE_ATOMIC_C_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CACC_BASE_ATOMIC_C_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CACC_BASE_ATOMIC_C_R {
