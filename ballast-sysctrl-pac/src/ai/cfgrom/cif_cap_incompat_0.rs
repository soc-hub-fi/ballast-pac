...
pub struct CIF_CAP_INCOMPAT_R(crate::FieldReader<u32, u32>);
impl CIF_CAP_INCOMPAT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CIF_CAP_INCOMPAT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CIF_CAP_INCOMPAT_R {
