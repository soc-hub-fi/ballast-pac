...
pub struct BN_SURFACE_STRIDE_R(crate::FieldReader<u32, u32>);
...
pub struct BN_SURFACE_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> BN_SURFACE_STRIDE_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn bn_surface_stride(&mut self) -> BN_SURFACE_STRIDE_W {
        BN_SURFACE_STRIDE_W { w: self }
    }
