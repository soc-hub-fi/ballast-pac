...
pub struct BS_BASE_ADDR_LOW_R(crate::FieldReader<u32, u32>);
...
pub struct BS_BASE_ADDR_LOW_W<'a> {
    w: &'a mut W,
}
impl<'a> BS_BASE_ADDR_LOW_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn bs_base_addr_low(&mut self) -> BS_BASE_ADDR_LOW_W {
        BS_BASE_ADDR_LOW_W { w: self }
    }
