...
pub struct BS_BASE_ADDR_HIGH_R(crate::FieldReader<u32>);
...
pub struct BS_BASE_ADDR_HIGH_W<'a> {
    w: &'a mut W,
}
impl<'a> BS_BASE_ADDR_HIGH_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn bs_base_addr_high(&mut self) -> BS_BASE_ADDR_HIGH_W {
        BS_BASE_ADDR_HIGH_W { w: self }
    }
