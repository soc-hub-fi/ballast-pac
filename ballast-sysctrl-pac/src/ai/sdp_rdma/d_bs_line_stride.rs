...
pub struct BS_LINE_STRIDE_R(crate::FieldReader<u32, u32>);
...
pub struct BS_LINE_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> BS_LINE_STRIDE_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn bs_line_stride(&mut self) -> BS_LINE_STRIDE_W {
        BS_LINE_STRIDE_W { w: self }
    }
