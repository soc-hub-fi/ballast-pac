...
#[doc = "Register `D_EW_LINE_STRIDE` writer"]
pub struct W(crate::W<D_EW_LINE_STRIDE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_EW_LINE_STRIDE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_EW_LINE_STRIDE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_EW_LINE_STRIDE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `EW_LINE_STRIDE` reader - "]
pub type EW_LINE_STRIDE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `EW_LINE_STRIDE` writer - "]
pub type EW_LINE_STRIDE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_EW_LINE_STRIDE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ew_line_stride(&mut self) -> EW_LINE_STRIDE_W<0> {
        EW_LINE_STRIDE_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_ew_line_stride::W](W) writer structure"]
impl crate::Writable for D_EW_LINE_STRIDE_SPEC {
    type Writer = W;
