...
pub struct STATUS_INF_INPUT_NUM_R(crate::FieldReader<u32>);
...
pub struct STATUS_INF_INPUT_NUM_W<'a> {
    w: &'a mut W,
}
impl<'a> STATUS_INF_INPUT_NUM_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn status_inf_input_num(&mut self) -> STATUS_INF_INPUT_NUM_W {
        STATUS_INF_INPUT_NUM_W { w: self }
    }
