...
pub struct DST_BASE_ADDR_HIGH_R(crate::FieldReader<u32, u32>);
...
pub struct DST_BASE_ADDR_HIGH_W<'a> {
    w: &'a mut W,
}
impl<'a> DST_BASE_ADDR_HIGH_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn dst_base_addr_high(&mut self) -> DST_BASE_ADDR_HIGH_W {
        DST_BASE_ADDR_HIGH_W { w: self }
    }
