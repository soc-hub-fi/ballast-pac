...
pub struct CUBE_IN_HEIGHT_R(crate::FieldReader<u16>);
...
pub struct CUBE_IN_HEIGHT_W<'a> {
    w: &'a mut W,
}
impl<'a> CUBE_IN_HEIGHT_W<'a> {
...
impl W {
    #[doc = "Bits 0:12"]
    #[inline(always)]
    pub fn cube_in_height(&mut self) -> CUBE_IN_HEIGHT_W {
        CUBE_IN_HEIGHT_W { w: self }
    }
