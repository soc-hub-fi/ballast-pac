...
pub struct CUBE_OUT_HEIGHT_R(crate::FieldReader<u16, u16>);
impl CUBE_OUT_HEIGHT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CUBE_OUT_HEIGHT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CUBE_OUT_HEIGHT_R {
...
pub struct CUBE_OUT_HEIGHT_W<'a> {
    w: &'a mut W,
}
impl<'a> CUBE_OUT_HEIGHT_W<'a> {
...
impl W {
    #[doc = "Bits 0:12"]
    #[inline(always)]
    pub fn cube_out_height(&mut self) -> CUBE_OUT_HEIGHT_W {
        CUBE_OUT_HEIGHT_W { w: self }
    }
