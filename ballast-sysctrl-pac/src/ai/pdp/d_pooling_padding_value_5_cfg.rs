...
#[doc = "Register `D_POOLING_PADDING_VALUE_5_CFG` writer"]
pub struct W(crate::W<D_POOLING_PADDING_VALUE_5_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_POOLING_PADDING_VALUE_5_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_POOLING_PADDING_VALUE_5_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_POOLING_PADDING_VALUE_5_CFG_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `PAD_VALUE_5X` reader - "]
pub type PAD_VALUE_5X_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PAD_VALUE_5X` writer - "]
pub type PAD_VALUE_5X_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_POOLING_PADDING_VALUE_5_CFG_SPEC, u32, u32, 19, O>;
impl R {
    #[doc = "Bits 0:18"]
    #[inline(always)]
    pub fn pad_value_5x(&self) -> PAD_VALUE_5X_R {
        PAD_VALUE_5X_R::new(self.bits & 0x0007_ffff)
    }
}
impl W {
    #[doc = "Bits 0:18"]
    #[inline(always)]
    #[must_use]
    pub fn pad_value_5x(&mut self) -> PAD_VALUE_5X_W<0> {
        PAD_VALUE_5X_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_pooling_padding_value_5_cfg::W](W) writer structure"]
impl crate::Writable for D_POOLING_PADDING_VALUE_5_CFG_SPEC {
    type Writer = W;
