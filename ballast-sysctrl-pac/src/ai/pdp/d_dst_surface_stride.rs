...
pub type DST_SURFACE_STRIDE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DST_SURFACE_STRIDE` writer - "]
pub type DST_SURFACE_STRIDE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DST_SURFACE_STRIDE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dst_surface_stride(&mut self) -> DST_SURFACE_STRIDE_W<0> {
        DST_SURFACE_STRIDE_W::new(self)
    }
