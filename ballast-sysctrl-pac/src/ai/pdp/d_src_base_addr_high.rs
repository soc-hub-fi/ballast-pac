...
pub struct SRC_BASE_ADDR_HIGH_R(crate::FieldReader<u32, u32>);
...
pub struct SRC_BASE_ADDR_HIGH_W<'a> {
    w: &'a mut W,
}
impl<'a> SRC_BASE_ADDR_HIGH_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn src_base_addr_high(&mut self) -> SRC_BASE_ADDR_HIGH_W {
        SRC_BASE_ADDR_HIGH_W { w: self }
    }
