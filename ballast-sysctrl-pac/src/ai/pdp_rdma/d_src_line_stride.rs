...
pub type SRC_LINE_STRIDE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SRC_LINE_STRIDE` writer - "]
pub type SRC_LINE_STRIDE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_SRC_LINE_STRIDE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_line_stride(&mut self) -> SRC_LINE_STRIDE_W<0> {
        SRC_LINE_STRIDE_W::new(self)
    }
