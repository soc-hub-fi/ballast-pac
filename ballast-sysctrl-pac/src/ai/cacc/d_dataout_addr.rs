...
pub type DATAOUT_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DATAOUT_ADDR` writer - "]
pub type DATAOUT_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DATAOUT_ADDR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dataout_addr(&mut self) -> DATAOUT_ADDR_W<0> {
        DATAOUT_ADDR_W::new(self)
    }
