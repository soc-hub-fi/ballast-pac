...
#[doc = "Register `D_LINE_STRIDE` writer"]
pub struct W(crate::W<D_LINE_STRIDE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_LINE_STRIDE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_LINE_STRIDE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_LINE_STRIDE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `LINE_STRIDE` reader - "]
pub type LINE_STRIDE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LINE_STRIDE` writer - "]
pub type LINE_STRIDE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_LINE_STRIDE_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:23"]
    #[inline(always)]
    pub fn line_stride(&self) -> LINE_STRIDE_R {
        LINE_STRIDE_R::new(self.bits & 0x00ff_ffff)
    }
}
impl W {
    #[doc = "Bits 0:23"]
    #[inline(always)]
    #[must_use]
    pub fn line_stride(&mut self) -> LINE_STRIDE_W<0> {
        LINE_STRIDE_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_line_stride::W](W) writer structure"]
impl crate::Writable for D_LINE_STRIDE_SPEC {
    type Writer = W;
