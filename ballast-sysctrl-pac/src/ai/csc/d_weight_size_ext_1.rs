...
pub struct WEIGHT_CHANNEL_EXT_R(crate::FieldReader<u16, u16>);
impl WEIGHT_CHANNEL_EXT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        WEIGHT_CHANNEL_EXT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for WEIGHT_CHANNEL_EXT_R {
...
pub struct WEIGHT_CHANNEL_EXT_W<'a> {
    w: &'a mut W,
}
impl<'a> WEIGHT_CHANNEL_EXT_W<'a> {
...
impl W {
    #[doc = "Bits 0:12"]
    #[inline(always)]
    pub fn weight_channel_ext(&mut self) -> WEIGHT_CHANNEL_EXT_W {
        WEIGHT_CHANNEL_EXT_W { w: self }
    }
    #[doc = "Bits 16:28"]
    #[inline(always)]
