...
pub struct LUT_LO_SLOPE_UFLOW_SCALE_R(crate::FieldReader<u16, u16>);
impl LUT_LO_SLOPE_UFLOW_SCALE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        LUT_LO_SLOPE_UFLOW_SCALE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LUT_LO_SLOPE_UFLOW_SCALE_R {
...
pub struct LUT_LO_SLOPE_UFLOW_SCALE_W<'a> {
    w: &'a mut W,
}
impl<'a> LUT_LO_SLOPE_UFLOW_SCALE_W<'a> {
...
pub struct LUT_LO_SLOPE_OFLOW_SCALE_R(crate::FieldReader<u16, u16>);
impl LUT_LO_SLOPE_OFLOW_SCALE_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        LUT_LO_SLOPE_OFLOW_SCALE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LUT_LO_SLOPE_OFLOW_SCALE_R {
    type Target = crate::FieldReader<u16, u16>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LUT_LO_SLOPE_OFLOW_SCALE_W<'a> {
    w: &'a mut W,
}
impl<'a> LUT_LO_SLOPE_OFLOW_SCALE_W<'a> {
    #[doc = r"Writes raw bits to the field"]
    #[inline(always)]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
...
impl W {
    #[doc = "Bits 0:15"]
    #[inline(always)]
    pub fn lut_lo_slope_uflow_scale(&mut self) -> LUT_LO_SLOPE_UFLOW_SCALE_W {
        LUT_LO_SLOPE_UFLOW_SCALE_W { w: self }
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    pub fn lut_lo_slope_oflow_scale(&mut self) -> LUT_LO_SLOPE_OFLOW_SCALE_W {
        LUT_LO_SLOPE_OFLOW_SCALE_W { w: self }
    }
