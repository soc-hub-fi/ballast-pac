...
pub type BS_MUL_SRC_R = crate::BitReader<BS_MUL_SRC_A>;
#[doc = "\n\nValue on reset: 0"]
...
pub type BS_MUL_SRC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, D_DP_BS_MUL_CFG_SPEC, BS_MUL_SRC_A, O>;
impl<'a, const O: u8> BS_MUL_SRC_W<'a, O> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type BS_MUL_SHIFT_VALUE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BS_MUL_SHIFT_VALUE` writer - "]
pub type BS_MUL_SHIFT_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DP_BS_MUL_CFG_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bs_mul_src(&mut self) -> BS_MUL_SRC_W<0> {
        BS_MUL_SRC_W::new(self)
    }
    #[doc = "Bits 8:15"]
    #[inline(always)]
    #[must_use]
    pub fn bs_mul_shift_value(&mut self) -> BS_MUL_SHIFT_VALUE_W<8> {
        BS_MUL_SHIFT_VALUE_W::new(self)
    }
