...
pub type EW_MUL_SRC_R = crate::BitReader<EW_MUL_SRC_A>;
#[doc = "\n\nValue on reset: 0"]
...
pub type EW_MUL_SRC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, D_DP_EW_MUL_CFG_SPEC, EW_MUL_SRC_A, O>;
impl<'a, const O: u8> EW_MUL_SRC_W<'a, O> {
    #[doc = "`0`"]
    #[inline(always)]
...
pub type EW_MUL_CVT_BYPASS_R = crate::BitReader<EW_MUL_CVT_BYPASS_A>;
#[doc = "\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
pub type EW_MUL_CVT_BYPASS_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, D_DP_EW_MUL_CFG_SPEC, EW_MUL_CVT_BYPASS_A, O>;
impl<'a, const O: u8> EW_MUL_CVT_BYPASS_W<'a, O> {
    #[doc = "`1`"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ew_mul_src(&mut self) -> EW_MUL_SRC_W<0> {
        EW_MUL_SRC_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn ew_mul_cvt_bypass(&mut self) -> EW_MUL_CVT_BYPASS_W<1> {
        EW_MUL_CVT_BYPASS_W::new(self)
    }
