...
#[doc = "Register `D_DST_LINE_STRIDE` writer"]
pub struct W(crate::W<D_DST_LINE_STRIDE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_DST_LINE_STRIDE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_DST_LINE_STRIDE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_DST_LINE_STRIDE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `DST_LINE_STRIDE` reader - "]
pub type DST_LINE_STRIDE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `DST_LINE_STRIDE` writer - "]
pub type DST_LINE_STRIDE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DST_LINE_STRIDE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dst_line_stride(&mut self) -> DST_LINE_STRIDE_W<0> {
        DST_LINE_STRIDE_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_dst_line_stride::W](W) writer structure"]
impl crate::Writable for D_DST_LINE_STRIDE_SPEC {
    type Writer = W;
