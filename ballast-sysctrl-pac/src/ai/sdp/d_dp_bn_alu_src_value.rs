...
pub type BN_ALU_OPERAND_R = crate::FieldReader<u16, u16>;
#[doc = "Field `BN_ALU_OPERAND` writer - "]
pub type BN_ALU_OPERAND_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DP_BN_ALU_SRC_VALUE_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bn_alu_operand(&mut self) -> BN_ALU_OPERAND_W<0> {
        BN_ALU_OPERAND_W::new(self)
    }
