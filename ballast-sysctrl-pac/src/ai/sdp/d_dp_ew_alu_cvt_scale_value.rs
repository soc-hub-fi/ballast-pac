...
#[doc = "Register `D_DP_EW_ALU_CVT_SCALE_VALUE` writer"]
pub struct W(crate::W<D_DP_EW_ALU_CVT_SCALE_VALUE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_DP_EW_ALU_CVT_SCALE_VALUE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_DP_EW_ALU_CVT_SCALE_VALUE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_DP_EW_ALU_CVT_SCALE_VALUE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `EW_ALU_CVT_SCALE` reader - "]
pub type EW_ALU_CVT_SCALE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `EW_ALU_CVT_SCALE` writer - "]
pub type EW_ALU_CVT_SCALE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DP_EW_ALU_CVT_SCALE_VALUE_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ew_alu_cvt_scale(&mut self) -> EW_ALU_CVT_SCALE_W<0> {
        EW_ALU_CVT_SCALE_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_dp_ew_alu_cvt_scale_value::W](W) writer structure"]
impl crate::Writable for D_DP_EW_ALU_CVT_SCALE_VALUE_SPEC {
    type Writer = W;
