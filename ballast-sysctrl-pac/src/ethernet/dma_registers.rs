...
pub mod irq;
#[doc = "irq_mask register accessor: an alias for `Reg<IRQ_MASK_SPEC>`"]
pub type IRQ_MASK = crate::Reg<irq_mask::IRQ_MASK_SPEC>;
#[doc = ""]
pub mod irq_mask;
#[doc = "rx_pkg_lgth register accessor: an alias for `Reg<RX_PKG_LGTH_SPEC>`"]
...
pub mod rx_pkg_lgth;
#[doc = "rx_pkg_lgth_cnt register accessor: an alias for `Reg<RX_PKG_LGTH_CNT_SPEC>`"]
...
#[doc = "rx_rb_rd_pointer register accessor: an alias for `Reg<RX_RB_RD_POINTER_SPEC>`"]
...
#[doc = "rx_rb_size register accessor: an alias for `Reg<RX_RB_SIZE_SPEC>`"]
...
pub mod rx_rb_size;
#[doc = "rx_rb_start_address register accessor: an alias for `Reg<RX_RB_START_ADDRESS_SPEC>`"]
...
#[doc = "tx_pkg_lgth register accessor: an alias for `Reg<TX_PKG_LGTH_SPEC>`"]
...
pub mod tx_pkg_lgth;
#[doc = "tx_pkg_lgth_cnt register accessor: an alias for `Reg<TX_PKG_LGTH_CNT_SPEC>`"]
...
#[doc = "tx_rb_start_addr register accessor: an alias for `Reg<TX_RB_START_ADDR_SPEC>`"]
...
#[doc = "tx_rb_size register accessor: an alias for `Reg<TX_RB_SIZE_SPEC>`"]
pub type TX_RB_SIZE = crate::Reg<tx_rb_size::TX_RB_SIZE_SPEC>;
#[doc = "Stores the ring buffer size for the associated DMA channel in bytes."]
pub mod tx_rb_size;
#[doc = "tx_rb_rd_pointer register accessor: an alias for `Reg<TX_RB_RD_POINTER_SPEC>`"]
