...
pub struct TX_PKG_LGTH_CNT_R(crate::FieldReader<u8, u8>);
impl TX_PKG_LGTH_CNT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        TX_PKG_LGTH_CNT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_PKG_LGTH_CNT_R {
