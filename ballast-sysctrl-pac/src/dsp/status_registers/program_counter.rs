...
pub struct PROGRAM_COUNTER_R(crate::FieldReader<u32, u32>);
impl PROGRAM_COUNTER_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PROGRAM_COUNTER_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PROGRAM_COUNTER_R {
