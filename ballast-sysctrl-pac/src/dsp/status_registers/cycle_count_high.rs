...
pub struct CYCLE_COUNT_HIGH_R(crate::FieldReader<u32, u32>);
impl CYCLE_COUNT_HIGH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CYCLE_COUNT_HIGH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CYCLE_COUNT_HIGH_R {
