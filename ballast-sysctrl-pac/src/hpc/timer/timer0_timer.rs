...
pub type TIMER0_TIMER_R = crate::FieldReader<u32, u32>;
#[doc = "Field `timer0_timer` writer - "]
pub type TIMER0_TIMER_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIMER0_TIMER_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer0_timer(&mut self) -> TIMER0_TIMER_W<0> {
        TIMER0_TIMER_W::new(self)
    }
