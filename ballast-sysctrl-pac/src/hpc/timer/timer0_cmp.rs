...
pub struct TIMER0_CMP_R(crate::FieldReader<u32, u32>);
impl TIMER0_CMP_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TIMER0_CMP_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TIMER0_CMP_R {
...
pub struct TIMER0_CMP_W<'a> {
    w: &'a mut W,
}
impl<'a> TIMER0_CMP_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn timer0_cmp(&mut self) -> TIMER0_CMP_W {
        TIMER0_CMP_W { w: self }
    }
