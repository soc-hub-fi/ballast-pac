...
pub struct NON_IDEMPOTENT_REGION_ADDR_BASE3_R(crate::FieldReader<u64, u64>);
impl NON_IDEMPOTENT_REGION_ADDR_BASE3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        NON_IDEMPOTENT_REGION_ADDR_BASE3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for NON_IDEMPOTENT_REGION_ADDR_BASE3_R {
...
pub struct NON_IDEMPOTENT_REGION_ADDR_BASE3_W<'a> {
    w: &'a mut W,
}
impl<'a> NON_IDEMPOTENT_REGION_ADDR_BASE3_W<'a> {
...
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn non_idempotent_region_addr_base3(&mut self) -> NON_IDEMPOTENT_REGION_ADDR_BASE3_W {
        NON_IDEMPOTENT_REGION_ADDR_BASE3_W { w: self }
    }
