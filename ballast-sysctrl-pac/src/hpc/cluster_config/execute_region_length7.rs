...
#[doc = "Field `execute_region_length7` reader - "]
pub struct EXECUTE_REGION_LENGTH7_R(crate::FieldReader<u64, u64>);
impl EXECUTE_REGION_LENGTH7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        EXECUTE_REGION_LENGTH7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EXECUTE_REGION_LENGTH7_R {
...
#[doc = "Field `execute_region_length7` writer - "]
pub struct EXECUTE_REGION_LENGTH7_W<'a> {
    w: &'a mut W,
}
impl<'a> EXECUTE_REGION_LENGTH7_W<'a> {
...
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn execute_region_length7(&self) -> EXECUTE_REGION_LENGTH7_R {
        EXECUTE_REGION_LENGTH7_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn execute_region_length7(&mut self) -> EXECUTE_REGION_LENGTH7_W {
        EXECUTE_REGION_LENGTH7_W { w: self }
    }
