...
pub type EXECUTE_REGION_LENGTH7_R = crate::FieldReader<u64, u64>;
#[doc = "Field `execute_region_length7` writer - "]
pub type EXECUTE_REGION_LENGTH7_W<'a, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn execute_region_length7(&mut self) -> EXECUTE_REGION_LENGTH7_W<0> {
        EXECUTE_REGION_LENGTH7_W::new(self)
    }
