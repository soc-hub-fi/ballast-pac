...
#[doc = "Field `non_idempotent_region_length0` reader - "]
pub struct NON_IDEMPOTENT_REGION_LENGTH0_R(crate::FieldReader<u64, u64>);
impl NON_IDEMPOTENT_REGION_LENGTH0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        NON_IDEMPOTENT_REGION_LENGTH0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for NON_IDEMPOTENT_REGION_LENGTH0_R {
...
#[doc = "Field `non_idempotent_region_length0` writer - "]
pub struct NON_IDEMPOTENT_REGION_LENGTH0_W<'a> {
    w: &'a mut W,
}
impl<'a> NON_IDEMPOTENT_REGION_LENGTH0_W<'a> {
...
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn non_idempotent_region_length0(&self) -> NON_IDEMPOTENT_REGION_LENGTH0_R {
        NON_IDEMPOTENT_REGION_LENGTH0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn non_idempotent_region_length0(&mut self) -> NON_IDEMPOTENT_REGION_LENGTH0_W {
        NON_IDEMPOTENT_REGION_LENGTH0_W { w: self }
    }
