...
pub type RTC_CFG0_R = crate::FieldReader<u64, u64>;
#[doc = "Field `rtc_cfg0` writer - "]
pub type RTC_CFG0_W<'a, const O: u8> = crate::FieldWriter<'a, u64, RTC_CFG0_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rtc_cfg0(&mut self) -> RTC_CFG0_W<0> {
        RTC_CFG0_W::new(self)
    }
