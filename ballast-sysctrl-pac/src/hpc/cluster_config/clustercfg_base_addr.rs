...
pub struct CLUSTERCFG_BASE_ADDR_R(crate::FieldReader<u64, u64>);
impl CLUSTERCFG_BASE_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        CLUSTERCFG_BASE_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CLUSTERCFG_BASE_ADDR_R {
...
pub struct CLUSTERCFG_BASE_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> CLUSTERCFG_BASE_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn clustercfg_base_addr(&mut self) -> CLUSTERCFG_BASE_ADDR_W {
        CLUSTERCFG_BASE_ADDR_W { w: self }
    }
