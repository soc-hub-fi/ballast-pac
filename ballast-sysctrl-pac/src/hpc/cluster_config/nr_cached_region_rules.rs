...
impl NR_CACHED_REGION_RULES_R {
    ...
    pub(crate) fn new(bits: u64) -> Self {
        NR_CACHED_REGION_RULES_R(crate::FieldReader::new(bits))
    }
}
...
pub struct NR_CACHED_REGION_RULES_W<'a> {
    w: &'a mut W,
}
impl<'a> NR_CACHED_REGION_RULES_W<'a> {
...
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn nr_cached_region_rules(&mut self) -> NR_CACHED_REGION_RULES_W {
        NR_CACHED_REGION_RULES_W { w: self }
    }
