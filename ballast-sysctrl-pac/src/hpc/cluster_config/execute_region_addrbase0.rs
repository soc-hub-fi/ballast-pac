...
pub type EXECUTE_REGION_ADDRBASE0_R = crate::FieldReader<u64, u64>;
#[doc = "Field `execute_region_addrbase0` writer - "]
pub type EXECUTE_REGION_ADDRBASE0_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, EXECUTE_REGION_ADDRBASE0_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn execute_region_addrbase0(&mut self) -> EXECUTE_REGION_ADDRBASE0_W<0> {
        EXECUTE_REGION_ADDRBASE0_W::new(self)
    }
