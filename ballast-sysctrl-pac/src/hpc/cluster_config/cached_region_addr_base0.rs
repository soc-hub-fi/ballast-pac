...
#[doc = "Field `cached_region_addr_base0` reader - "]
pub struct CACHED_REGION_ADDR_BASE0_R(crate::FieldReader<u64, u64>);
impl CACHED_REGION_ADDR_BASE0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        CACHED_REGION_ADDR_BASE0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CACHED_REGION_ADDR_BASE0_R {
...
#[doc = "Field `cached_region_addr_base0` writer - "]
pub struct CACHED_REGION_ADDR_BASE0_W<'a> {
    w: &'a mut W,
}
impl<'a> CACHED_REGION_ADDR_BASE0_W<'a> {
...
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn cached_region_addr_base0(&self) -> CACHED_REGION_ADDR_BASE0_R {
        CACHED_REGION_ADDR_BASE0_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn cached_region_addr_base0(&mut self) -> CACHED_REGION_ADDR_BASE0_W {
        CACHED_REGION_ADDR_BASE0_W { w: self }
    }
