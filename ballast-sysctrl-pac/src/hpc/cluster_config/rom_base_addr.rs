...
pub type ROM_BASE_ADDR_R = crate::FieldReader<u64, u64>;
#[doc = "Field `rom_base_addr` writer - "]
pub type ROM_BASE_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, ROM_BASE_ADDR_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rom_base_addr(&mut self) -> ROM_BASE_ADDR_W<0> {
        ROM_BASE_ADDR_W::new(self)
    }
