...
pub struct CACHED_REGION_ADDR_BASE2_R(crate::FieldReader<u64, u64>);
impl CACHED_REGION_ADDR_BASE2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        CACHED_REGION_ADDR_BASE2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CACHED_REGION_ADDR_BASE2_R {
...
pub struct CACHED_REGION_ADDR_BASE2_W<'a> {
    w: &'a mut W,
}
impl<'a> CACHED_REGION_ADDR_BASE2_W<'a> {
...
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn cached_region_addr_base2(&mut self) -> CACHED_REGION_ADDR_BASE2_W {
        CACHED_REGION_ADDR_BASE2_W { w: self }
    }
