...
pub struct EXECUTE_REGION_ADDR_BASE2_R(crate::FieldReader<u64, u64>);
impl EXECUTE_REGION_ADDR_BASE2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        EXECUTE_REGION_ADDR_BASE2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for EXECUTE_REGION_ADDR_BASE2_R {
...
pub struct EXECUTE_REGION_ADDR_BASE2_W<'a> {
    w: &'a mut W,
}
impl<'a> EXECUTE_REGION_ADDR_BASE2_W<'a> {
...
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn execute_region_addr_base2(&mut self) -> EXECUTE_REGION_ADDR_BASE2_W {
        EXECUTE_REGION_ADDR_BASE2_W { w: self }
    }
