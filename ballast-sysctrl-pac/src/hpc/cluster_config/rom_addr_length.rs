...
pub type ROM_ADDR_LENGTH_R = crate::FieldReader<u64, u64>;
#[doc = "Field `rom_addr_length` writer - "]
pub type ROM_ADDR_LENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, ROM_ADDR_LENGTH_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rom_addr_length(&mut self) -> ROM_ADDR_LENGTH_W<0> {
        ROM_ADDR_LENGTH_W::new(self)
    }
