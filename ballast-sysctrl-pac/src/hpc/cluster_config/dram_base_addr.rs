...
pub struct DRAM_BASE_ADDR_R(crate::FieldReader<u64, u64>);
impl DRAM_BASE_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        DRAM_BASE_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for DRAM_BASE_ADDR_R {
...
pub struct DRAM_BASE_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> DRAM_BASE_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn dram_base_addr(&mut self) -> DRAM_BASE_ADDR_W {
        DRAM_BASE_ADDR_W { w: self }
    }
