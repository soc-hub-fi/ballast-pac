...
pub type EXECUTE_REGION_ADDR_BASE4_R = crate::FieldReader<u64, u64>;
#[doc = "Field `execute_region_addr_base4` writer - "]
pub type EXECUTE_REGION_ADDR_BASE4_W<'a, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn execute_region_addr_base4(&mut self) -> EXECUTE_REGION_ADDR_BASE4_W<0> {
        EXECUTE_REGION_ADDR_BASE4_W::new(self)
    }
