...
pub struct L2_REPLACEMENT_POLICY_R(crate::FieldReader<u64, u64>);
impl L2_REPLACEMENT_POLICY_R {
    #[inline(always)]
    pub(crate) fn new(bits: u64) -> Self {
        L2_REPLACEMENT_POLICY_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for L2_REPLACEMENT_POLICY_R {
...
pub struct L2_REPLACEMENT_POLICY_W<'a> {
    w: &'a mut W,
}
impl<'a> L2_REPLACEMENT_POLICY_W<'a> {
...
impl W {
    #[doc = "Bits 0:63"]
    #[inline(always)]
    pub fn l2_replacement_policy(&mut self) -> L2_REPLACEMENT_POLICY_W {
        L2_REPLACEMENT_POLICY_W { w: self }
    }
