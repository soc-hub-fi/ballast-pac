...
pub struct FC_MASK5_R(crate::FieldReader<u32, u32>);
impl FC_MASK5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        FC_MASK5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FC_MASK5_R {
...
to 0b0 enables dispatching event to FC interrupt controller."]
    #[inline(always)]
    pub fn fc_mask5(&mut self) -> FC_MASK5_W {
        FC_MASK5_W { w: self }
    }
