...
pub struct PR_MASK7_R(crate::FieldReader<u32, u32>);
impl PR_MASK7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PR_MASK7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PR_MASK7_R {
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    pub fn pr_mask7(&mut self) -> PR_MASK7_W {
        PR_MASK7_W { w: self }
    }
