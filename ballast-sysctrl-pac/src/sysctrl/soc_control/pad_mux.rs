#[doc = "Register `PAD_MUX` reader"]
pub struct R(crate::R<PAD_MUX_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PAD_MUX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PAD_MUX_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PAD_MUX_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PAD_MUX` writer"]
pub struct W(crate::W<PAD_MUX_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PAD_MUX_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PAD_MUX_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PAD_MUX_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "The content of these registers can be used to multiplex pads when targeting an ASIC. The first register (0x1A10_4010) can be used to set the mux (2 bit select) from pin 0 (bits \\[1:0\\]) to 15 (bits \\[31:30\\]).\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pad_mux](index.html) module"]
pub struct PAD_MUX_SPEC;
impl crate::RegisterSpec for PAD_MUX_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pad_mux::R](R) reader structure"]
impl crate::Readable for PAD_MUX_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pad_mux::W](W) writer structure"]
impl crate::Writable for PAD_MUX_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets PAD_MUX to value 0"]
impl crate::Resettable for PAD_MUX_SPEC {
