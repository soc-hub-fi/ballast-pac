...
pub type C2C_REMAP_TX_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `c2c_remap_tx_addr` writer - "]
pub type C2C_REMAP_TX_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, C2C_REMAP_TX_ADDR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn c2c_remap_tx_addr(&mut self) -> C2C_REMAP_TX_ADDR_W<0> {
        C2C_REMAP_TX_ADDR_W::new(self)
    }
