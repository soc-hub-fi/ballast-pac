...
pub struct C2C_REMAP_RX_ADDR_R(crate::FieldReader<u32, u32>);
impl C2C_REMAP_RX_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        C2C_REMAP_RX_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for C2C_REMAP_RX_ADDR_R {
...
pub struct C2C_REMAP_RX_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> C2C_REMAP_RX_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn c2c_remap_rx_addr(&mut self) -> C2C_REMAP_RX_ADDR_W {
        C2C_REMAP_RX_ADDR_W { w: self }
    }
