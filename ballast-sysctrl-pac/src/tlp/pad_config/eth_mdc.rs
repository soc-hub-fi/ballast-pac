#[doc = "Register `eth_mdc` reader"]
pub struct R(crate::R<ETH_MDC_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_MDC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_MDC_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_MDC_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `eth_mdc` writer"]
pub struct W(crate::W<ETH_MDC_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETH_MDC_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ETH_MDC_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ETH_MDC_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eth_mdc](index.html) module"]
pub struct ETH_MDC_SPEC;
impl crate::RegisterSpec for ETH_MDC_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [eth_mdc::R](R) reader structure"]
impl crate::Readable for ETH_MDC_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eth_mdc::W](W) writer structure"]
impl crate::Writable for ETH_MDC_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets eth_mdc to value 0xa0"]
impl crate::Resettable for ETH_MDC_SPEC {
