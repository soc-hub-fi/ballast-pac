...
pub struct IRQ_1_ROUTE_REG_0_R(crate::FieldReader<u8, u8>);
impl IRQ_1_ROUTE_REG_0_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IRQ_1_ROUTE_REG_0_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IRQ_1_ROUTE_REG_0_R {
...
pub struct IRQ_1_ROUTE_REG_0_W<'a> {
    w: &'a mut W,
}
impl<'a> IRQ_1_ROUTE_REG_0_W<'a> {
...
impl R {
    ...
    pub fn irq_1_route_reg_0(&self) -> IRQ_1_ROUTE_REG_0_R {
        IRQ_1_ROUTE_REG_0_R::new((self.bits & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn irq_1_route_reg_0(&mut self) -> IRQ_1_ROUTE_REG_0_W {
        IRQ_1_ROUTE_REG_0_W { w: self }
    }
