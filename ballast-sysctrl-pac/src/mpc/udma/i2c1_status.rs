#[doc = "Register `I2C1_STATUS` reader"]
pub struct R(crate::R<I2C1_STATUS_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2C1_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2C1_STATUS_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2C1_STATUS_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2C1_STATUS` writer"]
pub struct W(crate::W<I2C1_STATUS_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2C1_STATUS_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2C1_STATUS_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2C1_STATUS_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type BUSY_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C1_STATUS_SPEC, bool, O>;
...
pub type ARB_LOST_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C1_STATUS_SPEC, bool, O>;
...
#[doc = "uDMA I2C Status register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2c1_status](index.html) module"]
pub struct I2C1_STATUS_SPEC;
impl crate::RegisterSpec for I2C1_STATUS_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2c1_status::R](R) reader structure"]
impl crate::Readable for I2C1_STATUS_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2c1_status::W](W) writer structure"]
impl crate::Writable for I2C1_STATUS_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets I2C1_STATUS to value 0"]
impl crate::Resettable for I2C1_STATUS_SPEC {
