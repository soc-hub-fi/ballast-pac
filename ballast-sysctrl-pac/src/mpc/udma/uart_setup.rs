...
impl From<BIT_LENGTH_A> for u8 {
    #[inline(always)]
    fn from(variant: BIT_LENGTH_A) -> Self {
        variant as _
    }
}
#[doc = "Field `BIT_LENGTH` reader - Character length bitfield: - 2'b00: 5 bits - 2'b01: 6 bits - 2'b10: 7 bits - 2'b11: 8 bits"]
pub struct BIT_LENGTH_R(crate::FieldReader<u8, BIT_LENGTH_A>);
impl BIT_LENGTH_R {
    #[inline(always)]
    ...
    pub fn variant(&self) -> BIT_LENGTH_A {
        match self.bits {
            0 => BIT_LENGTH_A::_5BITS,
            1 => BIT_LENGTH_A::_6BITS,
            2 => BIT_LENGTH_A::_7BITS,
            3 => BIT_LENGTH_A::_8BITS,
            _ => unreachable!(),
        }
    }
...
impl core::ops::Deref for BIT_LENGTH_R {
    type Target = crate::FieldReader<u8, BIT_LENGTH_A>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl<'a> BIT_LENGTH_W<'a> {
    ...
    pub fn _5bits(self) -> &'a mut W {
        self.variant(BIT_LENGTH_A::_5BITS)
    }
    #[doc = "`1`"]
    #[inline(always)]
    pub fn _6bits(self) -> &'a mut W {
        self.variant(BIT_LENGTH_A::_6BITS)
    }
    #[doc = "`10`"]
    #[inline(always)]
    pub fn _7bits(self) -> &'a mut W {
        self.variant(BIT_LENGTH_A::_7BITS)
    }
    #[doc = "`11`"]
    #[inline(always)]
