...
pub type C2C_REMAP_RX_MASK_R = crate::FieldReader<u32, u32>;
#[doc = "Field `c2c_remap_rx_mask` writer - "]
pub type C2C_REMAP_RX_MASK_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, C2C_REMAP_RX_MASK_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn c2c_remap_rx_mask(&mut self) -> C2C_REMAP_RX_MASK_W<0> {
        C2C_REMAP_RX_MASK_W::new(self)
    }
