#[doc = "Register `c2c_rx_ack` reader"]
pub struct R(crate::R<C2C_RX_ACK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<C2C_RX_ACK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<C2C_RX_ACK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<C2C_RX_ACK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `c2c_rx_ack` writer"]
pub struct W(crate::W<C2C_RX_ACK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<C2C_RX_ACK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<C2C_RX_ACK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<C2C_RX_ACK_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DRIVE_STRENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, C2C_RX_ACK_SPEC, u8, u8, 2, O>;
#[doc = "Field `output_enable` reader - "]
pub type OUTPUT_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `output_enable` writer - "]
pub type OUTPUT_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, C2C_RX_ACK_SPEC, bool, O>;
#[doc = "Field `pull_enable` reader - "]
pub type PULL_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `pull_enable` writer - "]
pub type PULL_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, C2C_RX_ACK_SPEC, bool, O>;
...
pub type PULL_DOWN_UP_W<'a, const O: u8> = crate::BitWriter<'a, u16, C2C_RX_ACK_SPEC, bool, O>;
#[doc = "Field `input_enable` reader - "]
pub type INPUT_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `input_enable` writer - "]
pub type INPUT_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, C2C_RX_ACK_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [c2c_rx_ack](index.html) module"]
pub struct C2C_RX_ACK_SPEC;
impl crate::RegisterSpec for C2C_RX_ACK_SPEC {
    type Ux = u16;
}
#[doc = "`read()` method returns [c2c_rx_ack::R](R) reader structure"]
impl crate::Readable for C2C_RX_ACK_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [c2c_rx_ack::W](W) writer structure"]
impl crate::Writable for C2C_RX_ACK_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets c2c_rx_ack to value 0"]
impl crate::Resettable for C2C_RX_ACK_SPEC {
