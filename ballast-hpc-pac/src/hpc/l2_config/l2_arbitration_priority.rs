...
pub type L2_ARBITRATION_PRIORITY_R = crate::FieldReader<u64, u64>;
#[doc = "Field `l2_arbitration_priority` writer - "]
pub type L2_ARBITRATION_PRIORITY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, L2_ARBITRATION_PRIORITY_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn l2_arbitration_priority(&mut self) -> L2_ARBITRATION_PRIORITY_W<0> {
        L2_ARBITRATION_PRIORITY_W::new(self)
    }
