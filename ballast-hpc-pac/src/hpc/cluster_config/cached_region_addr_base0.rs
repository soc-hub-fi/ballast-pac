...
pub type CACHED_REGION_ADDR_BASE0_R = crate::FieldReader<u64, u64>;
#[doc = "Field `cached_region_addr_base0` writer - "]
pub type CACHED_REGION_ADDR_BASE0_W<'a, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cached_region_addr_base0(&mut self) -> CACHED_REGION_ADDR_BASE0_W<0> {
        CACHED_REGION_ADDR_BASE0_W::new(self)
    }
