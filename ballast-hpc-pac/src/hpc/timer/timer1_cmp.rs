...
pub type TIMER1_CMP_R = crate::FieldReader<u32, u32>;
#[doc = "Field `timer1_cmp` writer - "]
pub type TIMER1_CMP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TIMER1_CMP_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer1_cmp(&mut self) -> TIMER1_CMP_W<0> {
        TIMER1_CMP_W::new(self)
    }
