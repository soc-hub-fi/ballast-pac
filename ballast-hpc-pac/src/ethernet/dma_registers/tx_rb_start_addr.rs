...
pub type TX_RB_START_ADDR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `tx_rb_start_addr` writer - "]
pub type TX_RB_START_ADDR_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_RB_START_ADDR_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_rb_start_addr(&mut self) -> TX_RB_START_ADDR_W<0> {
        TX_RB_START_ADDR_W::new(self)
    }
