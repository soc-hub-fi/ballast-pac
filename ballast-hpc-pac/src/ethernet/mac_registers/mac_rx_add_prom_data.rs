...
pub type MAC_RX_ADD_PROM_DATA_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MAC_rx_add_prom_data` writer - "]
pub type MAC_RX_ADD_PROM_DATA_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, MAC_RX_ADD_PROM_DATA_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mac_rx_add_prom_data(&mut self) -> MAC_RX_ADD_PROM_DATA_W<0> {
        MAC_RX_ADD_PROM_DATA_W::new(self)
    }
