...
pub type PAD_24_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PAD_24` writer - "]
pub type PAD_24_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PAD_CFG_8_SPEC, u16, u16, 10, O>;
#[doc = "Field `PAD_25` reader - "]
pub type PAD_25_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PAD_25` writer - "]
pub type PAD_25_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PAD_CFG_8_SPEC, u16, u16, 10, O>;
#[doc = "Field `PAD_26` reader - "]
pub type PAD_26_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PAD_26` writer - "]
pub type PAD_26_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PAD_CFG_8_SPEC, u16, u16, 10, O>;
impl R {
    #[doc = "Bits 0:9"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pad_24(&mut self) -> PAD_24_W<0> {
        PAD_24_W::new(self)
    }
    #[doc = "Bits 10:19"]
    #[inline(always)]
    #[must_use]
    pub fn pad_25(&mut self) -> PAD_25_W<10> {
        PAD_25_W::new(self)
    }
    #[doc = "Bits 20:29"]
    #[inline(always)]
    #[must_use]
    pub fn pad_26(&mut self) -> PAD_26_W<20> {
        PAD_26_W::new(self)
    }
