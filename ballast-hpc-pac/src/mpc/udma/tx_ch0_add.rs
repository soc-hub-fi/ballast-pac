...
#[doc = "Field `TX_CH0_ADD` reader - FILTER tx channel 0 address register"]
pub type TX_CH0_ADD_R = crate::FieldReader<u32, u32>;
#[doc = "Field `TX_CH0_ADD` writer - FILTER tx channel 0 address register"]
pub type TX_CH0_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, TX_CH0_ADD_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31 - FILTER tx channel 0 address register"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn tx_ch0_add(&mut self) -> TX_CH0_ADD_W<0> {
        TX_CH0_ADD_W::new(self)
    }
