#[doc = "Register `I2C1_RX_CFG` reader"]
pub struct R(crate::R<I2C1_RX_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<I2C1_RX_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<I2C1_RX_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<I2C1_RX_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `I2C1_RX_CFG` writer"]
pub struct W(crate::W<I2C1_RX_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<I2C1_RX_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<I2C1_RX_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<I2C1_RX_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CONTINOUS_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C1_RX_CFG_SPEC, bool, O>;
...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C1_RX_CFG_SPEC, bool, O>;
...
pub type CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C1_RX_CFG_SPEC, bool, O>;
impl R {
...
#[doc = "uDMA RX I2C stream configuration register.\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [i2c1_rx_cfg](index.html) module"]
pub struct I2C1_RX_CFG_SPEC;
impl crate::RegisterSpec for I2C1_RX_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [i2c1_rx_cfg::R](R) reader structure"]
impl crate::Readable for I2C1_RX_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [i2c1_rx_cfg::W](W) writer structure"]
impl crate::Writable for I2C1_RX_CFG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets I2C1_RX_CFG to value 0"]
impl crate::Resettable for I2C1_RX_CFG_SPEC {
