...
#[doc = "Register `D_DP_BS_ALU_CFG` writer"]
pub struct W(crate::W<D_DP_BS_ALU_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_DP_BS_ALU_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_DP_BS_ALU_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_DP_BS_ALU_CFG_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `BS_ALU_SRC` reader - "]
pub type BS_ALU_SRC_R = crate::BitReader<BS_ALU_SRC_A>;
#[doc = "\n\nValue on reset: 0"]
...
#[doc = "Field `BS_ALU_SRC` writer - "]
pub type BS_ALU_SRC_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, D_DP_BS_ALU_CFG_SPEC, BS_ALU_SRC_A, O>;
impl<'a, const O: u8> BS_ALU_SRC_W<'a, O> {
    #[doc = "`0`"]
    #[inline(always)]
    pub fn reg(self) -> &'a mut W {
        self.variant(BS_ALU_SRC_A::REG)
    }
    #[doc = "`1`"]
    #[inline(always)]
    pub fn mem(self) -> &'a mut W {
        self.variant(BS_ALU_SRC_A::MEM)
    }
}
#[doc = "Field `BS_ALU_SHIFT_VALUE` reader - "]
pub type BS_ALU_SHIFT_VALUE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `BS_ALU_SHIFT_VALUE` writer - "]
pub type BS_ALU_SHIFT_VALUE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DP_BS_ALU_CFG_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bs_alu_src(&mut self) -> BS_ALU_SRC_W<0> {
        BS_ALU_SRC_W::new(self)
    }
    #[doc = "Bits 8:13"]
    #[inline(always)]
    #[must_use]
    pub fn bs_alu_shift_value(&mut self) -> BS_ALU_SHIFT_VALUE_W<8> {
        BS_ALU_SHIFT_VALUE_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_dp_bs_alu_cfg::W](W) writer structure"]
impl crate::Writable for D_DP_BS_ALU_CFG_SPEC {
    type Writer = W;
