...
pub type EW_MUL_OPERAND_R = crate::FieldReader<u32, u32>;
#[doc = "Field `EW_MUL_OPERAND` writer - "]
pub type EW_MUL_OPERAND_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DP_EW_MUL_SRC_VALUE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ew_mul_operand(&mut self) -> EW_MUL_OPERAND_W<0> {
        EW_MUL_OPERAND_W::new(self)
    }
