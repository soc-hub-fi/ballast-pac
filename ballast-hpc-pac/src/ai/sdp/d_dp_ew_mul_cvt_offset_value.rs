...
pub struct EW_MUL_CVT_OFFSET_R(crate::FieldReader<u32>);
...
pub struct EW_MUL_CVT_OFFSET_W<'a> {
    w: &'a mut W,
}
impl<'a> EW_MUL_CVT_OFFSET_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ew_mul_cvt_offset(&mut self) -> EW_MUL_CVT_OFFSET_W {
        EW_MUL_CVT_OFFSET_W { w: self }
    }
