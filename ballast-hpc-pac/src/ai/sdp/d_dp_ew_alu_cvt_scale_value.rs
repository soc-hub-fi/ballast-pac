...
pub struct EW_ALU_CVT_SCALE_R(crate::FieldReader<u16>);
...
pub struct EW_ALU_CVT_SCALE_W<'a> {
    w: &'a mut W,
}
impl<'a> EW_ALU_CVT_SCALE_W<'a> {
...
impl W {
    #[doc = "Bits 0:15"]
    #[inline(always)]
    pub fn ew_alu_cvt_scale(&mut self) -> EW_ALU_CVT_SCALE_W {
        EW_ALU_CVT_SCALE_W { w: self }
    }
