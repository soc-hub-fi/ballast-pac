...
pub type LUT_LE_SLOPE_UFLOW_SCALE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LUT_LE_SLOPE_UFLOW_SCALE` writer - "]
pub type LUT_LE_SLOPE_UFLOW_SCALE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, S_LUT_LE_SLOPE_SCALE_SPEC, u16, u16, 16, O>;
#[doc = "Field `LUT_LE_SLOPE_OFLOW_SCALE` reader - "]
pub type LUT_LE_SLOPE_OFLOW_SCALE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `LUT_LE_SLOPE_OFLOW_SCALE` writer - "]
pub type LUT_LE_SLOPE_OFLOW_SCALE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, S_LUT_LE_SLOPE_SCALE_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lut_le_slope_uflow_scale(&mut self) -> LUT_LE_SLOPE_UFLOW_SCALE_W<0> {
        LUT_LE_SLOPE_UFLOW_SCALE_W::new(self)
    }
    #[doc = "Bits 16:31"]
    #[inline(always)]
    #[must_use]
    pub fn lut_le_slope_oflow_scale(&mut self) -> LUT_LE_SLOPE_OFLOW_SCALE_W<16> {
        LUT_LE_SLOPE_OFLOW_SCALE_W::new(self)
    }
