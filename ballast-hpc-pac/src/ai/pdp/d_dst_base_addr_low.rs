...
pub type DST_BASE_ADDR_LOW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DST_BASE_ADDR_LOW_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dst_base_addr_low(&mut self) -> DST_BASE_ADDR_LOW_W<0> {
        DST_BASE_ADDR_LOW_W::new(self)
    }
