...
pub type SRC_BASE_ADDR_LOW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SRC_BASE_ADDR_LOW` writer - "]
pub type SRC_BASE_ADDR_LOW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_SRC_BASE_ADDR_LOW_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_base_addr_low(&mut self) -> SRC_BASE_ADDR_LOW_W<0> {
        SRC_BASE_ADDR_LOW_W::new(self)
    }
