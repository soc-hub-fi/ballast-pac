...
#[doc = "Register `D_SRC_BASE_ADDR_HIGH` writer"]
pub struct W(crate::W<D_SRC_BASE_ADDR_HIGH_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_SRC_BASE_ADDR_HIGH_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_SRC_BASE_ADDR_HIGH_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_SRC_BASE_ADDR_HIGH_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `SRC_BASE_ADDR_HIGH` reader - "]
pub type SRC_BASE_ADDR_HIGH_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SRC_BASE_ADDR_HIGH` writer - "]
pub type SRC_BASE_ADDR_HIGH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_SRC_BASE_ADDR_HIGH_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src_base_addr_high(&mut self) -> SRC_BASE_ADDR_HIGH_W<0> {
        SRC_BASE_ADDR_HIGH_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_src_base_addr_high::W](W) writer structure"]
impl crate::Writable for D_SRC_BASE_ADDR_HIGH_SPEC {
    type Writer = W;
