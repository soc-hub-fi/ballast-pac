...
pub type STATUS_NAN_INPUT_NUM_R = crate::FieldReader<u32, u32>;
#[doc = "Field `STATUS_NAN_INPUT_NUM` writer - "]
pub type STATUS_NAN_INPUT_NUM_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_STATUS_NAN_INPUT_NUM_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn status_nan_input_num(&mut self) -> STATUS_NAN_INPUT_NUM_W<0> {
        STATUS_NAN_INPUT_NUM_W::new(self)
    }
