...
pub type BN_BASE_ADDR_LOW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `BN_BASE_ADDR_LOW` writer - "]
pub type BN_BASE_ADDR_LOW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_BN_BASE_ADDR_LOW_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bn_base_addr_low(&mut self) -> BN_BASE_ADDR_LOW_W<0> {
        BN_BASE_ADDR_LOW_W::new(self)
    }
