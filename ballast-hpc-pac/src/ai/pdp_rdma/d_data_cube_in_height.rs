...
#[doc = "Register `D_DATA_CUBE_IN_HEIGHT` writer"]
pub struct W(crate::W<D_DATA_CUBE_IN_HEIGHT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_DATA_CUBE_IN_HEIGHT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_DATA_CUBE_IN_HEIGHT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_DATA_CUBE_IN_HEIGHT_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CUBE_IN_HEIGHT` reader - "]
pub type CUBE_IN_HEIGHT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CUBE_IN_HEIGHT` writer - "]
pub type CUBE_IN_HEIGHT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DATA_CUBE_IN_HEIGHT_SPEC, u16, u16, 13, O>;
impl R {
    #[doc = "Bits 0:12"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cube_in_height(&mut self) -> CUBE_IN_HEIGHT_W<0> {
        CUBE_IN_HEIGHT_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_data_cube_in_height::W](W) writer structure"]
impl crate::Writable for D_DATA_CUBE_IN_HEIGHT_SPEC {
    type Writer = W;
