...
pub type WEIGHT_ADDR_HIGH_R = crate::FieldReader<u32, u32>;
#[doc = "Field `WEIGHT_ADDR_HIGH` writer - "]
pub type WEIGHT_ADDR_HIGH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_WEIGHT_ADDR_HIGH_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn weight_addr_high(&mut self) -> WEIGHT_ADDR_HIGH_W<0> {
        WEIGHT_ADDR_HIGH_W::new(self)
    }
