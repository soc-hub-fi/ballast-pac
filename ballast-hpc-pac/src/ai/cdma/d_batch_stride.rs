...
pub struct BATCH_STRIDE_R(crate::FieldReader<u32>);
impl BATCH_STRIDE_R {
    #[inline(always)]
...
pub struct BATCH_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> BATCH_STRIDE_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn batch_stride(&mut self) -> BATCH_STRIDE_W {
        BATCH_STRIDE_W { w: self }
    }
