...
pub type BYTE_PER_KERNEL_R = crate::FieldReader<u32, u32>;
#[doc = "Field `BYTE_PER_KERNEL` writer - "]
pub type BYTE_PER_KERNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_WEIGHT_SIZE_0_SPEC, u32, u32, 18, O>;
impl R {
    #[doc = "Bits 0:17"]
    #[inline(always)]
    pub fn byte_per_kernel(&self) -> BYTE_PER_KERNEL_R {
        BYTE_PER_KERNEL_R::new(self.bits & 0x0003_ffff)
    }
}
impl W {
    #[doc = "Bits 0:17"]
    #[inline(always)]
    #[must_use]
    pub fn byte_per_kernel(&mut self) -> BYTE_PER_KERNEL_W<0> {
        BYTE_PER_KERNEL_W::new(self)
    }
