...
pub type RX_RB_START_ADDRESS_R = crate::FieldReader<u32, u32>;
#[doc = "Field `rx_rb_start_address` writer - "]
pub type RX_RB_START_ADDRESS_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, RX_RB_START_ADDRESS_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rx_rb_start_address(&mut self) -> RX_RB_START_ADDRESS_W<0> {
        RX_RB_START_ADDRESS_W::new(self)
    }
