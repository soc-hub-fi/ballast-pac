...
impl IRQ_0_ROUTE_REG_2_R {
    ...
    pub(crate) fn new(bits: u8) -> Self {
        IRQ_0_ROUTE_REG_2_R(crate::FieldReader::new(bits))
    }
}
...
pub struct IRQ_0_ROUTE_REG_2_W<'a> {
    w: &'a mut W,
}
impl<'a> IRQ_0_ROUTE_REG_2_W<'a> {
...
impl R {
    ...
    pub fn irq_0_route_reg_2(&self) -> IRQ_0_ROUTE_REG_2_R {
        IRQ_0_ROUTE_REG_2_R::new((self.bits & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn irq_0_route_reg_2(&mut self) -> IRQ_0_ROUTE_REG_2_W {
        IRQ_0_ROUTE_REG_2_W { w: self }
    }
