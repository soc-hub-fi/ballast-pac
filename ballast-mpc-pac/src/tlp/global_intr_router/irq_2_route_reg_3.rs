...
pub struct IRQ_2_ROUTE_REG_3_R(crate::FieldReader<u8, u8>);
impl IRQ_2_ROUTE_REG_3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IRQ_2_ROUTE_REG_3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IRQ_2_ROUTE_REG_3_R {
...
pub struct IRQ_2_ROUTE_REG_3_W<'a> {
    w: &'a mut W,
}
impl<'a> IRQ_2_ROUTE_REG_3_W<'a> {
...
impl R {
    ...
    pub fn irq_2_route_reg_3(&self) -> IRQ_2_ROUTE_REG_3_R {
        IRQ_2_ROUTE_REG_3_R::new((self.bits & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn irq_2_route_reg_3(&mut self) -> IRQ_2_ROUTE_REG_3_W {
        IRQ_2_ROUTE_REG_3_W { w: self }
    }
