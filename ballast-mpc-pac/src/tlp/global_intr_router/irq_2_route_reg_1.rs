...
pub type IRQ_2_ROUTE_REG_1_R = crate::FieldReader<u8, u8>;
#[doc = "Field `irq_2_route_reg_1` writer - "]
pub type IRQ_2_ROUTE_REG_1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, IRQ_2_ROUTE_REG_1_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn irq_2_route_reg_1(&self) -> IRQ_2_ROUTE_REG_1_R {
        IRQ_2_ROUTE_REG_1_R::new(self.bits & 0x1f)
    }
}
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    #[must_use]
    pub fn irq_2_route_reg_1(&mut self) -> IRQ_2_ROUTE_REG_1_W<0> {
        IRQ_2_ROUTE_REG_1_W::new(self)
    }
