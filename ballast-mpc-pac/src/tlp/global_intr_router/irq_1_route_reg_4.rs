...
pub struct IRQ_1_ROUTE_REG_4_R(crate::FieldReader<u8, u8>);
impl IRQ_1_ROUTE_REG_4_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IRQ_1_ROUTE_REG_4_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IRQ_1_ROUTE_REG_4_R {
...
pub struct IRQ_1_ROUTE_REG_4_W<'a> {
    w: &'a mut W,
}
impl<'a> IRQ_1_ROUTE_REG_4_W<'a> {
...
impl R {
    ...
    pub fn irq_1_route_reg_4(&self) -> IRQ_1_ROUTE_REG_4_R {
        IRQ_1_ROUTE_REG_4_R::new((self.bits & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn irq_1_route_reg_4(&mut self) -> IRQ_1_ROUTE_REG_4_W {
        IRQ_1_ROUTE_REG_4_W { w: self }
    }
