...
pub struct IRQ_0_ROUTE_REG_1_R(crate::FieldReader<u8, u8>);
impl IRQ_0_ROUTE_REG_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        IRQ_0_ROUTE_REG_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for IRQ_0_ROUTE_REG_1_R {
...
pub struct IRQ_0_ROUTE_REG_1_W<'a> {
    w: &'a mut W,
}
impl<'a> IRQ_0_ROUTE_REG_1_W<'a> {
...
impl R {
    ...
    pub fn irq_0_route_reg_1(&self) -> IRQ_0_ROUTE_REG_1_R {
        IRQ_0_ROUTE_REG_1_R::new((self.bits & 0x1f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:4"]
    #[inline(always)]
    pub fn irq_0_route_reg_1(&mut self) -> IRQ_0_ROUTE_REG_1_W {
        IRQ_0_ROUTE_REG_1_W { w: self }
    }
