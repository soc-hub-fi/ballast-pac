...
pub type AI_MEM_TIMING_MODE_R = crate::FieldReader<u16, u16>;
#[doc = "Field `AI_mem_timing_mode` writer - "]
pub type AI_MEM_TIMING_MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, AI_MEM_TIMING_MODE_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ai_mem_timing_mode(&mut self) -> AI_MEM_TIMING_MODE_W<0> {
        AI_MEM_TIMING_MODE_W::new(self)
    }
