...
pub type PULL_DOWN_W<'a, const O: u8> = crate::BitWriter<'a, u8, ETH_RX_CLK_SPEC, bool, O>;
#[doc = "Field `pull_up` reader - "]
pub type PULL_UP_R = crate::BitReader<bool>;
#[doc = "Field `pull_up` writer - "]
pub type PULL_UP_W<'a, const O: u8> = crate::BitWriter<'a, u8, ETH_RX_CLK_SPEC, bool, O>;
...
pub type DRIVE_STRENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, ETH_RX_CLK_SPEC, u8, u8, 3, O>;
#[doc = "Field `output_enable` reader - "]
pub type OUTPUT_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `output_enable` writer - "]
pub type OUTPUT_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u8, ETH_RX_CLK_SPEC, bool, O>;
#[doc = "Field `input_enable` reader - "]
pub type INPUT_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `input_enable` writer - "]
pub type INPUT_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u8, ETH_RX_CLK_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
