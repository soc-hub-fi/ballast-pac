...
pub type DRIVE_STRENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u16, C2C_RX_VLD_SPEC, u8, u8, 2, O>;
#[doc = "Field `output_enable` reader - "]
pub type OUTPUT_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `output_enable` writer - "]
pub type OUTPUT_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, C2C_RX_VLD_SPEC, bool, O>;
#[doc = "Field `pull_enable` reader - "]
pub type PULL_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `pull_enable` writer - "]
pub type PULL_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, C2C_RX_VLD_SPEC, bool, O>;
...
pub type PULL_DOWN_UP_W<'a, const O: u8> = crate::BitWriter<'a, u16, C2C_RX_VLD_SPEC, bool, O>;
#[doc = "Field `input_enable` reader - "]
pub type INPUT_ENABLE_R = crate::BitReader<bool>;
#[doc = "Field `input_enable` writer - "]
pub type INPUT_ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u16, C2C_RX_VLD_SPEC, bool, O>;
impl R {
    #[doc = "Bits 0:1"]
    #[inline(always)]
