#[doc = "Register `eth_rx_ctl` reader"]
pub struct R(crate::R<ETH_RX_CTL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_RX_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_RX_CTL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_RX_CTL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `eth_rx_ctl` writer"]
pub struct W(crate::W<ETH_RX_CTL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETH_RX_CTL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ETH_RX_CTL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ETH_RX_CTL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eth_rx_ctl](index.html) module"]
pub struct ETH_RX_CTL_SPEC;
impl crate::RegisterSpec for ETH_RX_CTL_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [eth_rx_ctl::R](R) reader structure"]
impl crate::Readable for ETH_RX_CTL_SPEC {
    type Reader = R;
}
