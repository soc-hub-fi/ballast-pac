#[doc = "Register `eth_mdio` reader"]
pub struct R(crate::R<ETH_MDIO_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ETH_MDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ETH_MDIO_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ETH_MDIO_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `eth_mdio` writer"]
pub struct W(crate::W<ETH_MDIO_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ETH_MDIO_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ETH_MDIO_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ETH_MDIO_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PULL_DOWN_W<'a, const O: u8> = crate::BitWriter<'a, u8, ETH_MDIO_SPEC, bool, O>;
#[doc = "Field `pull_up` reader - "]
pub type PULL_UP_R = crate::BitReader<bool>;
#[doc = "Field `pull_up` writer - "]
pub type PULL_UP_W<'a, const O: u8> = crate::BitWriter<'a, u8, ETH_MDIO_SPEC, bool, O>;
...
pub type DRIVE_STRENGTH_W<'a, const O: u8> =
    crate::FieldWriter<'a, u8, ETH_MDIO_SPEC, u8, u8, 3, O>;
...
#[doc = "\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [eth_mdio](index.html) module"]
pub struct ETH_MDIO_SPEC;
impl crate::RegisterSpec for ETH_MDIO_SPEC {
    type Ux = u8;
}
#[doc = "`read()` method returns [eth_mdio::R](R) reader structure"]
impl crate::Readable for ETH_MDIO_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [eth_mdio::W](W) writer structure"]
impl crate::Writable for ETH_MDIO_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets eth_mdio to value 0xa0"]
impl crate::Resettable for ETH_MDIO_SPEC {
