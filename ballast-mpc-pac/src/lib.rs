#![doc = "Peripheral access API for BALLAST microcontrollers (generated using svd2rust v0.23.1 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl MPC {
    ...
    pub const PTR: *const mpc::RegisterBlock = 0x1a00_0000 as *const _;
...
impl SYSCTRL {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const sysctrl::RegisterBlock = 0x2a00_0000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
...
#[allow(unused_imports)]
pub use crate::{mpc as cpu_subsys, MPC as CPU_SUBSYS};
