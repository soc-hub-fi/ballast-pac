...
#[doc = "Field `PAD_MUX_1` reader - "]
pub struct PAD_MUX_1_R(crate::FieldReader<u32, u32>);
impl PAD_MUX_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PAD_MUX_1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PAD_MUX_1_R {
...
#[doc = "Field `PAD_MUX_1` writer - "]
pub struct PAD_MUX_1_W<'a> {
    w: &'a mut W,
}
impl<'a> PAD_MUX_1_W<'a> {
...
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn pad_mux_1(&self) -> PAD_MUX_1_R {
        PAD_MUX_1_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn pad_mux_1(&mut self) -> PAD_MUX_1_W {
        PAD_MUX_1_W { w: self }
    }
