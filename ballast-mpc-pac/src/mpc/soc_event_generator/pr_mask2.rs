...
pub struct PR_MASK2_R(crate::FieldReader<u32, u32>);
impl PR_MASK2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PR_MASK2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PR_MASK2_R {
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    pub fn pr_mask2(&mut self) -> PR_MASK2_W {
        PR_MASK2_W { w: self }
    }
