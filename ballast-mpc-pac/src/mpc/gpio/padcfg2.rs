...
pub struct PADCFG2_R(crate::FieldReader<u32, u32>);
impl PADCFG2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PADCFG2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PADCFG2_R {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn padcfg2(&mut self) -> PADCFG2_W {
        PADCFG2_W { w: self }
    }
