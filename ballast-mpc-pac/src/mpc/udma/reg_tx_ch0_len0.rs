...
pub struct R(crate::R<REG_TX_CH0_LEN0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<REG_TX_CH0_LEN0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<REG_TX_CH0_LEN0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<REG_TX_CH0_LEN0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `REG_TX_CH0_LEN0` writer"]
pub struct W(crate::W<REG_TX_CH0_LEN0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<REG_TX_CH0_LEN0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<REG_TX_CH0_LEN0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<REG_TX_CH0_LEN0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "FILTER tx channel length1 register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [reg_tx_ch0_len0](index.html) module"]
pub struct REG_TX_CH0_LEN0_SPEC;
impl crate::RegisterSpec for REG_TX_CH0_LEN0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [reg_tx_ch0_len0::R](R) reader structure"]
impl crate::Readable for REG_TX_CH0_LEN0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [reg_tx_ch0_len0::W](W) writer structure"]
impl crate::Writable for REG_TX_CH0_LEN0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets REG_TX_CH0_LEN0 to value 0"]
impl crate::Resettable for REG_TX_CH0_LEN0_SPEC {
    #[inline(always)]
