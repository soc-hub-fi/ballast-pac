#[doc = "Register `CAM_RX_CFG` reader"]
pub struct R(crate::R<CAM_RX_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CAM_RX_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CAM_RX_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CAM_RX_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CAM_RX_CFG` writer"]
pub struct W(crate::W<CAM_RX_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CAM_RX_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CAM_RX_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CAM_RX_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CONTINOUS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CAM_RX_CFG_SPEC, bool, O>;
...
#[doc = "Channel transfer size used to increment uDMA buffer address pointer: - 2'b00: +1 (8 bits) - 2'b01: +2 (16 bits) - 2'b10: +4 (32 bits) - 2'b11: +0\n\nValue on reset: 0"]
...
impl DATASIZE_R {
    ...
    pub fn variant(&self) -> DATASIZE_A {
        match self.bits {
            0 => DATASIZE_A::_8BITS,
            1 => DATASIZE_A::_16BITS,
            2 => DATASIZE_A::_32BITS,
            3 => DATASIZE_A::_0BITS,
            _ => unreachable!(),
        }
    }
    ...
    #[doc = "Checks if the value of the field is `_0BITS`"]
    #[inline(always)]
    pub fn is_0bits(&self) -> bool {
        *self == DATASIZE_A::_0BITS
    }
}
#[doc = "Field `DATASIZE` writer - Channel transfer size used to increment uDMA buffer address pointer: - 2'b00: +1 (8 bits) - 2'b01: +2 (16 bits) - 2'b10: +4 (32 bits) - 2'b11: +0"]
pub type DATASIZE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CAM_RX_CFG_SPEC, u8, DATASIZE_A, 2, O>;
impl<'a, const O: u8> DATASIZE_W<'a, O> {
    ...
    #[doc = "`11`"]
    #[inline(always)]
    pub fn _0bits(self) -> &'a mut W {
        self.variant(DATASIZE_A::_0BITS)
    }
}
...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CAM_RX_CFG_SPEC, bool, O>;
...
pub type CLR_W<'a, const O: u8> = crate::BitWriter<'a, u32, CAM_RX_CFG_SPEC, bool, O>;
impl R {
    ...
    #[doc = "Bits 1:2 - Channel transfer size used to increment uDMA buffer address pointer: - 2'b00: +1 (8 bits) - 2'b01: +2 (16 bits) - 2'b10: +4 (32 bits) - 2'b11: +0"]
    #[inline(always)]
...
#[doc = "RX Camera uDMA transfer configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cam_rx_cfg](index.html) module"]
pub struct CAM_RX_CFG_SPEC;
impl crate::RegisterSpec for CAM_RX_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cam_rx_cfg::R](R) reader structure"]
impl crate::Readable for CAM_RX_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cam_rx_cfg::W](W) writer structure"]
impl crate::Writable for CAM_RX_CFG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CAM_RX_CFG to value 0"]
impl crate::Resettable for CAM_RX_CFG_SPEC {
