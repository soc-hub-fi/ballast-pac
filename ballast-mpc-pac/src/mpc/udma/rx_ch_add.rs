...
pub struct RX_CH_ADD_R(crate::FieldReader<u32>);
impl RX_CH_ADD_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        RX_CH_ADD_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_CH_ADD_R {
...
pub struct RX_CH_ADD_W<'a> {
    w: &'a mut W,
}
impl<'a> RX_CH_ADD_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn rx_ch_add(&mut self) -> RX_CH_ADD_W {
        RX_CH_ADD_W { w: self }
    }
