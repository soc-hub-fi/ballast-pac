...
pub struct BREAKPOINT_2_ADDR_R(crate::FieldReader<u32, u32>);
impl BREAKPOINT_2_ADDR_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        BREAKPOINT_2_ADDR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for BREAKPOINT_2_ADDR_R {
...
pub struct BREAKPOINT_2_ADDR_W<'a> {
    w: &'a mut W,
}
impl<'a> BREAKPOINT_2_ADDR_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn breakpoint_2_addr(&mut self) -> BREAKPOINT_2_ADDR_W {
        BREAKPOINT_2_ADDR_W { w: self }
    }
