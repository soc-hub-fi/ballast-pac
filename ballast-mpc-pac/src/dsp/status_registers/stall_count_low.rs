...
pub struct STALL_COUNT_LOW_R(crate::FieldReader<u32, u32>);
impl STALL_COUNT_LOW_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        STALL_COUNT_LOW_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for STALL_COUNT_LOW_R {
