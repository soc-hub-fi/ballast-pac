...
pub type NON_IDEMPOTENT_REGION_LENGTH0_R = crate::FieldReader<u64, u64>;
#[doc = "Field `non_idempotent_region_length0` writer - "]
pub type NON_IDEMPOTENT_REGION_LENGTH0_W<'a, const O: u8> =
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn non_idempotent_region_length0(&mut self) -> NON_IDEMPOTENT_REGION_LENGTH0_W<0> {
        NON_IDEMPOTENT_REGION_LENGTH0_W::new(self)
    }
