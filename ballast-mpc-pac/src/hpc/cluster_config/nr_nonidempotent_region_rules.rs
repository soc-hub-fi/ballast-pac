...
pub type NR_NONIDEMPOTENT_REGION_RULES_R = crate::FieldReader<u64, u64>;
#[doc = "Field `nr_nonidempotent_region_rules` writer - "]
pub type NR_NONIDEMPOTENT_REGION_RULES_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, NR_NONIDEMPOTENT_REGION_RULES_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn nr_nonidempotent_region_rules(&mut self) -> NR_NONIDEMPOTENT_REGION_RULES_W<0> {
        NR_NONIDEMPOTENT_REGION_RULES_W::new(self)
    }
