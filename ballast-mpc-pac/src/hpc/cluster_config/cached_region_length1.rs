...
pub type CACHED_REGION_LENGTH1_R = crate::FieldReader<u64, u64>;
#[doc = "Field `cached_region_length1` writer - "]
pub type CACHED_REGION_LENGTH1_W<'a, const O: u8> =
    crate::FieldWriter<'a, u64, CACHED_REGION_LENGTH1_SPEC, u64, u64, 64, O>;
impl R {
    #[doc = "Bits 0:63"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cached_region_length1(&mut self) -> CACHED_REGION_LENGTH1_W<0> {
        CACHED_REGION_LENGTH1_W::new(self)
    }
