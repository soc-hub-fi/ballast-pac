...
pub struct WR_WEIGHT_BDMA_R(crate::FieldReader<u8>);
...
pub struct WR_WEIGHT_SDP_R(crate::FieldReader<u8>);
...
pub struct WR_WEIGHT_PDP_R(crate::FieldReader<u8>);
...
pub struct WR_WEIGHT_CDP_R(crate::FieldReader<u8>);
