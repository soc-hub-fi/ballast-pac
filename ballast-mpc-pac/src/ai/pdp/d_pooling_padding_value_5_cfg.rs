...
pub struct PAD_VALUE_5X_R(crate::FieldReader<u32>);
impl PAD_VALUE_5X_R {
    #[inline(always)]
...
pub struct PAD_VALUE_5X_W<'a> {
    w: &'a mut W,
}
impl<'a> PAD_VALUE_5X_W<'a> {
...
impl W {
    #[doc = "Bits 0:18"]
    #[inline(always)]
    pub fn pad_value_5x(&mut self) -> PAD_VALUE_5X_W {
        PAD_VALUE_5X_W { w: self }
    }
