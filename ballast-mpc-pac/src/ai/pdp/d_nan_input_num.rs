...
pub struct NAN_INPUT_NUM_R(crate::FieldReader<u32, u32>);
impl NAN_INPUT_NUM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        NAN_INPUT_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for NAN_INPUT_NUM_R {
