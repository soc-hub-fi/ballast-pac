...
pub type DATAIN_CHANNEL_R = crate::FieldReader<u16, u16>;
#[doc = "Field `DATAIN_CHANNEL` writer - "]
pub type DATAIN_CHANNEL_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DATAIN_SIZE_1_SPEC, u16, u16, 13, O>;
impl R {
    #[doc = "Bits 0:12"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn datain_channel(&mut self) -> DATAIN_CHANNEL_W<0> {
        DATAIN_CHANNEL_W::new(self)
    }
