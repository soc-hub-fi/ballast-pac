...
#[doc = "Register `D_WEIGHT_ADDR_LOW` writer"]
pub struct W(crate::W<D_WEIGHT_ADDR_LOW_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_WEIGHT_ADDR_LOW_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_WEIGHT_ADDR_LOW_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_WEIGHT_ADDR_LOW_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `WEIGHT_ADDR_LOW` reader - "]
pub type WEIGHT_ADDR_LOW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `WEIGHT_ADDR_LOW` writer - "]
pub type WEIGHT_ADDR_LOW_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_WEIGHT_ADDR_LOW_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn weight_addr_low(&mut self) -> WEIGHT_ADDR_LOW_W<0> {
        WEIGHT_ADDR_LOW_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_weight_addr_low::W](W) writer structure"]
impl crate::Writable for D_WEIGHT_ADDR_LOW_SPEC {
    type Writer = W;
