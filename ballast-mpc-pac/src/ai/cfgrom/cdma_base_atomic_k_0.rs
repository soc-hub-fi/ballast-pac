...
pub struct CDMA_BASE_ATOMIC_K_R(crate::FieldReader<u32, u32>);
impl CDMA_BASE_ATOMIC_K_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CDMA_BASE_ATOMIC_K_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CDMA_BASE_ATOMIC_K_R {
