...
pub struct CSC_BASE_CBUF_BANK_WIDTH_R(crate::FieldReader<u32, u32>);
impl CSC_BASE_CBUF_BANK_WIDTH_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CSC_BASE_CBUF_BANK_WIDTH_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CSC_BASE_CBUF_BANK_WIDTH_R {
