...
pub struct CSC_BASE_WEIGHT_TYPES_R(crate::FieldReader<u16, u16>);
impl CSC_BASE_WEIGHT_TYPES_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CSC_BASE_WEIGHT_TYPES_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CSC_BASE_WEIGHT_TYPES_R {
