...
pub struct CDMA_BASE_CBUF_BANK_NUM_R(crate::FieldReader<u32, u32>);
impl CDMA_BASE_CBUF_BANK_NUM_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CDMA_BASE_CBUF_BANK_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CDMA_BASE_CBUF_BANK_NUM_R {
