...
pub struct CMAC_B_BASE_WEIGHT_TYPES_R(crate::FieldReader<u16, u16>);
impl CMAC_B_BASE_WEIGHT_TYPES_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        CMAC_B_BASE_WEIGHT_TYPES_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CMAC_B_BASE_WEIGHT_TYPES_R {
