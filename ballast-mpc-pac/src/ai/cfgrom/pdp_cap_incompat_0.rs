...
pub struct PDP_CAP_INCOMPAT_R(crate::FieldReader<u32, u32>);
impl PDP_CAP_INCOMPAT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PDP_CAP_INCOMPAT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PDP_CAP_INCOMPAT_R {
