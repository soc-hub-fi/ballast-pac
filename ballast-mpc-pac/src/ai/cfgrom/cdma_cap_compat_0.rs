...
pub struct CDMA_CAP_COMPAT_R(crate::FieldReader<u32, u32>);
impl CDMA_CAP_COMPAT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CDMA_CAP_COMPAT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CDMA_CAP_COMPAT_R {
