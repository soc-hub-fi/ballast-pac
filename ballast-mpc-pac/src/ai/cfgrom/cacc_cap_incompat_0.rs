...
pub struct CACC_CAP_INCOMPAT_R(crate::FieldReader<u32, u32>);
impl CACC_CAP_INCOMPAT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        CACC_CAP_INCOMPAT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CACC_CAP_INCOMPAT_R {
