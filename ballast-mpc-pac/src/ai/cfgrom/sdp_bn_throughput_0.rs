...
pub struct SDP_BN_THROUGHPUT_R(crate::FieldReader<u32, u32>);
impl SDP_BN_THROUGHPUT_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        SDP_BN_THROUGHPUT_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SDP_BN_THROUGHPUT_R {
