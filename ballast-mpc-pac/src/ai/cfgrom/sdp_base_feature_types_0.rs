...
pub struct SDP_BASE_FEATURE_TYPES_R(crate::FieldReader<u16, u16>);
impl SDP_BASE_FEATURE_TYPES_R {
    #[inline(always)]
    pub(crate) fn new(bits: u16) -> Self {
        SDP_BASE_FEATURE_TYPES_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SDP_BASE_FEATURE_TYPES_R {
