...
pub struct BS_MUL_OPERAND_R(crate::FieldReader<u16>);
...
pub struct BS_MUL_OPERAND_W<'a> {
    w: &'a mut W,
}
impl<'a> BS_MUL_OPERAND_W<'a> {
...
impl W {
    #[doc = "Bits 0:15"]
    #[inline(always)]
    pub fn bs_mul_operand(&mut self) -> BS_MUL_OPERAND_W {
        BS_MUL_OPERAND_W { w: self }
    }
