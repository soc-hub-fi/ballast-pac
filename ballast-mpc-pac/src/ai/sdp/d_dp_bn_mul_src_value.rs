...
pub type BN_MUL_OPERAND_R = crate::FieldReader<u16, u16>;
#[doc = "Field `BN_MUL_OPERAND` writer - "]
pub type BN_MUL_OPERAND_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DP_BN_MUL_SRC_VALUE_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bn_mul_operand(&mut self) -> BN_MUL_OPERAND_W<0> {
        BN_MUL_OPERAND_W::new(self)
    }
