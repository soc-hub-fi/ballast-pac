...
#[doc = "Register `S_LUT_LO_SLOPE_SHIFT` writer"]
pub struct W(crate::W<S_LUT_LO_SLOPE_SHIFT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<S_LUT_LO_SLOPE_SHIFT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<S_LUT_LO_SLOPE_SHIFT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<S_LUT_LO_SLOPE_SHIFT_SPEC>) -> Self {
        W(writer)
    }
}
