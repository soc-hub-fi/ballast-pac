...
pub struct DST_BATCH_STRIDE_R(crate::FieldReader<u32>);
...
pub struct DST_BATCH_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> DST_BATCH_STRIDE_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn dst_batch_stride(&mut self) -> DST_BATCH_STRIDE_W {
        DST_BATCH_STRIDE_W { w: self }
    }
