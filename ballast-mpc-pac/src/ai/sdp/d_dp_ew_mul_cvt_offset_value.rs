...
#[doc = "Register `D_DP_EW_MUL_CVT_OFFSET_VALUE` writer"]
pub struct W(crate::W<D_DP_EW_MUL_CVT_OFFSET_VALUE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<D_DP_EW_MUL_CVT_OFFSET_VALUE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<D_DP_EW_MUL_CVT_OFFSET_VALUE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<D_DP_EW_MUL_CVT_OFFSET_VALUE_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `EW_MUL_CVT_OFFSET` reader - "]
pub type EW_MUL_CVT_OFFSET_R = crate::FieldReader<u32, u32>;
#[doc = "Field `EW_MUL_CVT_OFFSET` writer - "]
pub type EW_MUL_CVT_OFFSET_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_DP_EW_MUL_CVT_OFFSET_VALUE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ew_mul_cvt_offset(&mut self) -> EW_MUL_CVT_OFFSET_W<0> {
        EW_MUL_CVT_OFFSET_W::new(self)
    }
...
#[doc = "`write(|w| ..)` method takes [d_dp_ew_mul_cvt_offset_value::W](W) writer structure"]
impl crate::Writable for D_DP_EW_MUL_CVT_OFFSET_VALUE_SPEC {
    type Writer = W;
