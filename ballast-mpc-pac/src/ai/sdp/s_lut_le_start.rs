...
pub type LUT_LE_START_R = crate::FieldReader<u32, u32>;
#[doc = "Field `LUT_LE_START` writer - "]
pub type LUT_LE_START_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, S_LUT_LE_START_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn lut_le_start(&mut self) -> LUT_LE_START_W<0> {
        LUT_LE_START_W::new(self)
    }
