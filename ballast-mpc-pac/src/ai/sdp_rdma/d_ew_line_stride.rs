...
pub struct EW_LINE_STRIDE_R(crate::FieldReader<u32>);
...
pub struct EW_LINE_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> EW_LINE_STRIDE_W<'a> {
...
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn ew_line_stride(&mut self) -> EW_LINE_STRIDE_W {
        EW_LINE_STRIDE_W { w: self }
    }
