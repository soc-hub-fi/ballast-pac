...
pub type BN_BATCH_STRIDE_R = crate::FieldReader<u32, u32>;
#[doc = "Field `BN_BATCH_STRIDE` writer - "]
pub type BN_BATCH_STRIDE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, D_BN_BATCH_STRIDE_SPEC, u32, u32, 32, O>;
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn bn_batch_stride(&mut self) -> BN_BATCH_STRIDE_W<0> {
        BN_BATCH_STRIDE_W::new(self)
    }
