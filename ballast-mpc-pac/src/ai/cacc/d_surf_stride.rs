...
pub struct SURF_STRIDE_R(crate::FieldReader<u32>);
impl SURF_STRIDE_R {
    #[inline(always)]
...
pub struct SURF_STRIDE_W<'a> {
    w: &'a mut W,
}
impl<'a> SURF_STRIDE_W<'a> {
...
impl R {
    ...
    pub fn surf_stride(&self) -> SURF_STRIDE_R {
        SURF_STRIDE_R::new((self.bits & 0x00ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:23"]
    #[inline(always)]
    pub fn surf_stride(&mut self) -> SURF_STRIDE_W {
        SURF_STRIDE_W { w: self }
    }
