...
pub struct PR_MASK3_R(crate::FieldReader<u32, u32>);
impl PR_MASK3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PR_MASK3_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PR_MASK3_R {
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    pub fn pr_mask3(&mut self) -> PR_MASK3_W {
        PR_MASK3_W { w: self }
    }
