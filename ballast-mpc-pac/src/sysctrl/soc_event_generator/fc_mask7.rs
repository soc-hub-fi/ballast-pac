...
pub struct FC_MASK7_R(crate::FieldReader<u32, u32>);
impl FC_MASK7_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        FC_MASK7_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FC_MASK7_R {
...
to 0b0 enables dispatching event to FC interrupt controller."]
    #[inline(always)]
    pub fn fc_mask7(&mut self) -> FC_MASK7_W {
        FC_MASK7_W { w: self }
    }
