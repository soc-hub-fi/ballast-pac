...
pub struct PR_MASK5_R(crate::FieldReader<u32, u32>);
impl PR_MASK5_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        PR_MASK5_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for PR_MASK5_R {
...
to 0b0 enables dispatching event to peripherals."]
    #[inline(always)]
    pub fn pr_mask5(&mut self) -> PR_MASK5_W {
        PR_MASK5_W { w: self }
    }
