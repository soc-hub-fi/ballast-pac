...
pub struct PAD_CFG_16_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_16_R {
    #[inline(always)]
...
pub struct PAD_CFG_17_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_17_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_18_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_18_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_19_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_19_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
