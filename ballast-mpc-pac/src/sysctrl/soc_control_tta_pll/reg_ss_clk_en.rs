...
impl REG_SS_CLK_EN_R {
    ...
    pub(crate) fn new(bits: u32) -> Self {
        REG_SS_CLK_EN_R(crate::FieldReader::new(bits))
    }
}
...
#[doc = "Field `REG_SS_CLK_EN` writer - Assertion of the Subsystem bit, Enables clock to the corresponding subsystem. Bit definition is mentioned in adjoining table"]
pub struct REG_SS_CLK_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> REG_SS_CLK_EN_W<'a> {
...
impl R {
    #[doc = "Bits 0:31 - Assertion of the Subsystem bit, Enables clock to the corresponding subsystem. Bit definition is mentioned in adjoining table"]
    #[inline(always)]
    pub fn reg_ss_clk_en(&self) -> REG_SS_CLK_EN_R {
        REG_SS_CLK_EN_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31 - Assertion of the Subsystem bit, Enables clock to the corresponding subsystem. Bit definition is mentioned in adjoining table"]
    #[inline(always)]
    pub fn reg_ss_clk_en(&mut self) -> REG_SS_CLK_EN_W {
        REG_SS_CLK_EN_W { w: self }
    }
