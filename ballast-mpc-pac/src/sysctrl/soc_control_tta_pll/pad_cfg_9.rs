...
pub struct PAD_CFG_36_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_36_R {
    #[inline(always)]
...
pub struct PAD_CFG_37_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_37_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_38_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_38_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_39_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_39_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
