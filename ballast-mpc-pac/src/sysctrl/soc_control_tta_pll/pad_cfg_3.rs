...
pub struct PAD_CFG_12_R(crate::FieldReader<u8>);
impl PAD_CFG_12_R {
    #[inline(always)]
...
pub struct PAD_CFG_13_R(crate::FieldReader<u8>);
impl PAD_CFG_13_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_14_R(crate::FieldReader<u8>);
impl PAD_CFG_14_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_15_R(crate::FieldReader<u8>);
impl PAD_CFG_15_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
impl R {
    ...
    pub fn pad_cfg_12(&self) -> PAD_CFG_12_R {
        PAD_CFG_12_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 8:13"]
    #[inline(always)]
    pub fn pad_cfg_13(&self) -> PAD_CFG_13_R {
        PAD_CFG_13_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
    #[doc = "Bits 16:21"]
    #[inline(always)]
    pub fn pad_cfg_14(&self) -> PAD_CFG_14_R {
        PAD_CFG_14_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bits 24:29"]
    #[inline(always)]
    pub fn pad_cfg_15(&self) -> PAD_CFG_15_R {
        PAD_CFG_15_R::new(((self.bits >> 24) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5"]
