...
pub struct PAD_CFG_20_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_20_R {
    #[inline(always)]
...
pub struct PAD_CFG_21_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_21_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_22_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_22_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_23_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_23_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
