...
pub struct PAD_CFG_0_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_0_R {
    #[inline(always)]
...
pub struct PAD_CFG_1_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_2_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
pub struct PAD_CFG_3_R(crate::FieldReader<u8, u8>);
impl PAD_CFG_3_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
...
impl R {
    ...
    pub fn pad_cfg_0(&self) -> PAD_CFG_0_R {
        PAD_CFG_0_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 8:13"]
    #[inline(always)]
    pub fn pad_cfg_1(&self) -> PAD_CFG_1_R {
        PAD_CFG_1_R::new(((self.bits >> 8) & 0x3f) as u8)
    }
    #[doc = "Bits 16:21"]
    #[inline(always)]
    pub fn pad_cfg_2(&self) -> PAD_CFG_2_R {
        PAD_CFG_2_R::new(((self.bits >> 16) & 0x3f) as u8)
    }
    #[doc = "Bits 24:29"]
    #[inline(always)]
    pub fn pad_cfg_3(&self) -> PAD_CFG_3_R {
        PAD_CFG_3_R::new(((self.bits >> 24) & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5"]
