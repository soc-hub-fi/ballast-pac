#[doc = "Register `T0_TH_CHANNEL[%s]` reader"]
pub struct R(crate::R<T0_TH_CHANNEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T0_TH_CHANNEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<T0_TH_CHANNEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<T0_TH_CHANNEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T0_TH_CHANNEL[%s]` writer"]
pub struct W(crate::W<T0_TH_CHANNEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T0_TH_CHANNEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<T0_TH_CHANNEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<T0_TH_CHANNEL_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "ADV_TIMER0 channel 0 threshold configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [t0_th_channel](index.html) module"]
pub struct T0_TH_CHANNEL_SPEC;
impl crate::RegisterSpec for T0_TH_CHANNEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [t0_th_channel::R](R) reader structure"]
impl crate::Readable for T0_TH_CHANNEL_SPEC {
    type Reader = R;
}
