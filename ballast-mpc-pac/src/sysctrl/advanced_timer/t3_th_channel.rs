#[doc = "Register `T3_TH_CHANNEL[%s]` reader"]
pub struct R(crate::R<T3_TH_CHANNEL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<T3_TH_CHANNEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<T3_TH_CHANNEL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<T3_TH_CHANNEL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `T3_TH_CHANNEL[%s]` writer"]
pub struct W(crate::W<T3_TH_CHANNEL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<T3_TH_CHANNEL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<T3_TH_CHANNEL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<T3_TH_CHANNEL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type TH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, T3_TH_CHANNEL_SPEC, u16, u16, 16, O>;
...
pub type MODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, T3_TH_CHANNEL_SPEC, u8, MODE_A, 3, O>;
...
#[doc = "ADV_TIMER3 channel 0 threshold configuration register\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [t3_th_channel](index.html) module"]
pub struct T3_TH_CHANNEL_SPEC;
impl crate::RegisterSpec for T3_TH_CHANNEL_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [t3_th_channel::R](R) reader structure"]
impl crate::Readable for T3_TH_CHANNEL_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [t3_th_channel::W](W) writer structure"]
impl crate::Writable for T3_TH_CHANNEL_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets T3_TH_CHANNEL[%s]
to value 0"]
impl crate::Resettable for T3_TH_CHANNEL_SPEC {
