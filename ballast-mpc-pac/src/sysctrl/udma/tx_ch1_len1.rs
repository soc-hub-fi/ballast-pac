...
#[doc = "Field `TX_CH1_LEN1` reader - "]
pub struct TX_CH1_LEN1_R(crate::FieldReader<u32>);
impl TX_CH1_LEN1_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        TX_CH1_LEN1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for TX_CH1_LEN1_R {
...
#[doc = "Field `TX_CH1_LEN1` writer - "]
pub struct TX_CH1_LEN1_W<'a> {
    w: &'a mut W,
}
impl<'a> TX_CH1_LEN1_W<'a> {
...
impl R {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn tx_ch1_len1(&self) -> TX_CH1_LEN1_R {
        TX_CH1_LEN1_R::new(self.bits)
    }
}
impl W {
    #[doc = "Bits 0:31"]
    #[inline(always)]
    pub fn tx_ch1_len1(&mut self) -> TX_CH1_LEN1_W {
        TX_CH1_LEN1_W { w: self }
    }
