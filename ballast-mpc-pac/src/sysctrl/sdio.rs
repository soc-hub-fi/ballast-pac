#[doc = "CMD_OP register accessor: an alias for `Reg<CMD_OP_SPEC>`"]
...
#[doc = ""]
pub mod cmd_arg;
#[doc = "DATA_SETUP register accessor: an alias for `Reg<DATA_SETUP_SPEC>`"]
...
#[doc = ""]
pub mod status;
#[doc = "RSP3 register accessor: an alias for `Reg<RSP3_SPEC>`"]
pub type RSP3 = crate::Reg<rsp3::RSP3_SPEC>;
#[doc = ""]
pub mod rsp3;
#[doc = "RSP1 register accessor: an alias for `Reg<RSP1_SPEC>`"]
pub type RSP1 = crate::Reg<rsp1::RSP1_SPEC>;
#[doc = ""]
pub mod rsp1;
#[doc = "RCA register accessor: an alias for `Reg<RCA_SPEC>`"]
...
pub mod cid0;
#[doc = "CLK_DIV_0 register accessor: an alias for `Reg<CLK_DIV_0_SPEC>`"]
pub type CLK_DIV_0 = crate::Reg<clk_div_0::CLK_DIV_0_SPEC>;
#[doc = ""]
pub mod clk_div_0;
#[doc = "RSP2 register accessor: an alias for `Reg<RSP2_SPEC>`"]
