...
pub struct RESPONSE_WORD2_R(crate::FieldReader<u32, u32>);
impl RESPONSE_WORD2_R {
    #[inline(always)]
    pub(crate) fn new(bits: u32) -> Self {
        RESPONSE_WORD2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RESPONSE_WORD2_R {
